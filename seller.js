...
function initSellerMyProducts(){
  ...
  form.addEventListener('submit', function(e){
    ...
    if(idx>-1){
      products[idx].name = document.getElementById('ef-name').value.trim();
      products[idx].price = Number(document.getElementById('ef-price').value);
      products[idx].mrp = Number(document.getElementById('ef-mrp').value);
      products[idx].stock = Number(document.getElementById('ef-stock').value);
      products[idx].desc = document.getElementById('ef-desc').value.trim();
...
function initSellerAddProduct(){
  ...
  document.getElementById('add-product-form').addEventListener('submit', function(e){
    e.preventDefault();
    const emoji = document.getElementById('ap-emoji').value || '🛍️';
    ...
    products.push({
      ...
      mrp: Number(document.getElementById('ap-mrp').value),
